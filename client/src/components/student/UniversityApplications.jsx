...
// // import { getStudentById } from '../../features/students/studentSlice'; // To refresh profile after applying
...
// //     toast.success("University added to profile!");
// //     dispatch(getStudentById(student._id)); // Refresh profile to show new app
// //   };
...
// //         <div className="mb-6">
// //             <h2 className="text-xl font-bold text-gray-800">University Applications</h2>
// //             <p className="text-sm text-gray-500 mt-1">Track application status for this student.</p>
// //         </div>

// //         {/* 1. Add Application Form */}
// //         <div className="bg-green-50 p-6 rounded-lg border border-green-100 mb-6">
// //             <h4 className="font-bold text-green-800 mb-4 flex items-center gap-2">
// //                 <Plus size={16}/> Shortlist New University
// //             </h4>
...
// //                 onClick={handleApply}
// //                 disabled={isLoading}
// //                 className="mt-4 bg-green-600 text-white px-4 py-2 rounded font-medium hover:bg-green-700 w-full md:w-auto flex justify-center"
// //             >
// //                 {isLoading ? <Loader2 className="animate-spin" /> : "Add to Profile"}
// //             </button>
// //         </div>
...
// //                 <p className="text-gray-400 text-center italic py-4">No applications yet.</p>
// //             )}

// //             {student.applications?.map((app) => (
// //                 <div key={app._id} className="bg-white border border-gray-200 rounded-lg p-5 flex flex-col md:flex-row justify-between items-start md:items-center shadow-sm hover:shadow-md transition">
...
// //                                 <Calendar size={14}/> {app.intake} • {app.course}
// //                             </p>
// //                         </div>
// //                     </div>
...
// //                             ${app.status === 'Visa Granted' ? 'bg-green-100 text-green-700 border-green-200' : 
...
//                 <p className="text-sm text-gray-500">Manage university shortlisting and application status.</p>
//             </div>
//         </div>
...
//             <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Current Applications</h4>
