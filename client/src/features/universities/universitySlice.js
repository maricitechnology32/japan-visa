...
// const initialState = {
//   universities: [], // Consultancy's list
//   masterSearchResults: [], // Search results from Master DB
//   isLoading: false,
//   isError: false,
//   isSuccess: false,
//   message: '',
...
// // Add/Import University
// export const addUniversity = createAsyncThunk('universities/add', async (data, thunkAPI) => {
//   try {
//     // Determine endpoint based on data type (manual add vs import)
//     const endpoint = data.masterId ? '/universities/import' : '/universities';
...
//     return response.data.data; // Returns updated applications array
//   } catch (error) {
//     return thunkAPI.rejectWithValue(error.response?.data?.message || error.message);
//   }
// });
...
//         state.isLoading = false;
//         state.isSuccess = true;
//         state.message = 'Application Added to Student Profile';
//       });
//   },
// });
